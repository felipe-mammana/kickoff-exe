...
return [
    ...
    ['PUT', '/api/v1/machines/(?P<id>\d+)', ['ApiV1Controller', 'updateMachine'], true, true],
    ['PATCH', '/api/v1/machines/(?P<id>\d+)', ['ApiV1Controller', 'updateMachine'], true, true],
    ['DELETE', '/api/v1/machines/(?P<id>\d+)', ['ApiV1Controller', 'deactivateMachine'], true, true],
    ...
    ['DELETE', '/api/v1/machine-photos/(?P<id>\d+)', ['ApiV1Controller', 'deleteMachinePhoto'], true, true],
];
